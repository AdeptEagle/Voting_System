    ...
    <div id="header-carousel" class="carousel slide header-box" data-ride="carousel"data-interval="4000">
            ...
            <div class="carousel-inner">
                <div class="carousel-item active">
                    <img src="<?php echo e(asset('Images/Slide1.jpg')); ?>" alt="First slide">
                ...
                <div class="carousel-item">
                    <img src="<?php echo e(asset('Images/Slide2.jpg')); ?>" alt="Second slide">
                </div>
                <div class="carousel-item">
                    <img src="<?php echo e(asset('Images/Slide3.jpg')); ?>" alt="Third slide">
                </div>
                <div class="carousel-item">
                    <img src="<?php echo e(asset('Images/Slide4.jpg')); ?>" alt="Fourth slide">
                    <div class="carousel-caption d-none d-md-block">
                </div>
            </div>
...
<?php /**PATH C:\Xampp\htdocs\AppDev\Project-Cabardo\resources\views/Voting/home.blade.php ENDPATH**/ ?>