...
<head>
  ...
  <link rel="stylesheet" href="<?php echo e(asset('Css/candidates.css')); ?>"> 
</head>
<body>
...
<div class="scroll-container">
    <div class="card">
      <div class="flip-card-inner">
        <div class="flip-card-front">
          <img src="<?php echo e(asset('CandidateImages/GalleryIm1.jpg')); ?>" alt="Image 1">
        </div>
    ...
    <div class="card">
      <div class="flip-card-inner">
        <div class="flip-card-front">
          <img src="<?php echo e(asset('CandidateImages/GalleryIm2.jpg')); ?>" alt="Image 2">
        </div>
        <div class="flip-card-back">
    ...
    <div class="card">
      <div class="flip-card-inner">
        <div class="flip-card-front">
          <img src="<?php echo e(asset('CandidateImages/GalleryIm3.jpg')); ?>"alt="Image 3">
        </div>
        <div class="flip-card-back">
    ...
    <div class="card">
      <div class="flip-card-inner">
        <div class="flip-card-front">
          <img src="<?php echo e(asset('CandidateImages/GalleryIm4.jpg')); ?>" alt="Image 4">
        </div>
        <div class="flip-card-back">
    ...
    <div class="card">
      <div class="flip-card-inner">
        <div class="flip-card-front">
          <img src="<?php echo e(asset('CandidateImages/GalleryIm5.jpg')); ?>" alt="Image 5">
        </div>
        <div class="flip-card-back">
    ...
    <div class="card">
      <div class="flip-card-inner">
        <div class="flip-card-front">
          <img src="<?php echo e(asset('CandidateImages/GalleryIm6.jpg')); ?>"alt="Image 6">
        </div>
        <div class="flip-card-back">
...
</html><?php /**PATH C:\Xampp\htdocs\AppDev\Project-Cabardo\resources\views/Voting/candidates.blade.php ENDPATH**/ ?>